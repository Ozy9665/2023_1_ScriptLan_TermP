...
class App(tkinter.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.grid_columnconfigure(0, weight=1)  # 열 크기 조정
        self.grid_columnconfigure(1, weight=0)
        self.grid_columnconfigure(2, weight=0)
        self.grid_rowconfigure(1, weight=1)

        self.search_bar = tkinter.Entry(self, width=50)   # 텍스트 입력필드 제공
        self.search_bar.grid(row=0, column=0, pady=10, padx=10, sticky="we")    # 첫줄
        self.search_bar.focus()     # 실행 시 자동으로 search_bar에  입력 가능
        ...
        self.map_widget.set_address("한국산업기술대학교")
